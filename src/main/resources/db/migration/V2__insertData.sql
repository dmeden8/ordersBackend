INSERT INTO caffe_orders.user_account (username, password, name, email, oib, address, owner_name, tel_number, status, register_time) 
  VALUES ('grga', '$2a$10$rcxWBuu4eOqSNErWHOH3COKGBgdU/C/mWhdczf6jz8Vhhap/j6klq','Grga','grga@gmail.com', '90682024349', 'Krležina 15', 'Ivan Grgiæ', '052/542-735', 'A', '2016-01-01T13:12:59.498+02:00[Europe/Zagreb]');
INSERT INTO caffe_orders.user_account (username, password, name, email, oib, address, owner_name, tel_number, status, register_time)  
